...
let sendMessageWelcomeNewUser = (sender_psid) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            //send text message
            let response1 = {
                "text": `Hi ${username}! Welcome to WPL Support, where you will find what you need.`
            };
...
let sendSubEmail = (sender_psid) => {
    return new Promise(async (resolve, reject) => {
        try {
            let response = templateMessage.sendSubEmailTemplate();
            await sendMessage(sender_psid, response);
            resolve("done");
        } catch (e) {
            reject(e);
...
let sendTalkAgent = (sender_psid) => {
    return new Promise(async (resolve, reject) => {
        try {
            let response = templateMessage.sendTalkAgentTemplate();
            await sendMessage(sender_psid, response);
            resolve("done");
        } catch (e) {
            reject(e);
...
module.exports = {
    ...
    sendSubEmail: sendSubEmail,
    sendTalkAgent: sendTalkAgent
};
