...
let sendTalkAgentTemplate = ()=>{
    return {
        "attachment":{
            "type":"template",
            "payload":{
                "template_type":"button",
                "text":"What is the best email to reach you by?",
                "buttons":[
                    {
                        "type": "postback",
                        "title": "Cancel",
...
module.exports = {
    ...
    sendSubEmailTemplate: sendSubEmailTemplate,
    sendTalkAgentTemplate: sendTalkAgentTemplate
};
